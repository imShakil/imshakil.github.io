      ...
      <div className="flex flex-wrap gap-1 md:gap-2 border-b border-emerald-500/10 overflow-x-auto">
         {tabs.map((tab) => (
           <button
             ...
             className={`px-2 md:px-6 py-2 md:py-3 text-sm md:text-base font-semibold transition-all duration-300 flex items-center gap-1 md:gap-2 border-b-2 whitespace-nowrap uppercase tracking-[0.12em] ${
               activeTab === tab.id
        ...
        {activeTab === 'blog' && (
          <div className="space-y-6 animate-fadeIn">
            <div className="flex items-center gap-3 mb-8">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-emerald-200">Latest from Medium</h2>
            </div>

            {mediumPosts.length === 0 ? (
              <div className="terminal-panel rounded-lg p-12 text-center">
                <p className="text-emerald-100/70 mb-4">No posts found yet</p>
                <a
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {mediumPosts.map((post, index) => (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group flex flex-col h-full terminal-panel hover:border-emerald-400/40 rounded-xl overflow-hidden transition-all duration-300 card-hover"
                  >
                    {post.image && (
                    ...
                    <div className="p-6 flex-1 flex flex-col">
                      <h3 className="text-lg font-semibold text-emerald-200 group-hover:text-emerald-100 transition line-clamp-2 mb-2">
                        {post.title}
                      </h3>
                      <p className="text-sm text-emerald-100/50 mb-3">
                      ...
                      <p className="text-emerald-100/70 text-sm line-clamp-3 flex-1 mb-4">
                        {post.description}
                      </p>
                      <div className="text-emerald-300 group-hover:text-emerald-200 transition inline-flex items-center gap-2 font-semibold">
                        Read More
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                          <path d="M13.54 12a6.8 6.8 0 01-6.77 6.82A6.8 6.8 0 010 12a6.8 6.8 0 016.77-6.82A6.8 6.8 0 0113.54 12zM20.96 12c0 3.54-1.51 6.42-3.38 6.42-1.87 0-3.39-2.88-3.39-6.42s1.52-6.42 3.39-6.42c1.87 0 3.38 2.88 3.38 6.42M24 12c0 3.17-.53 5.75-1.19 5.75-.59 0-1.07-2.15-1.07-5.05V6.3c0-2.9.48-5.05 1.07-5.05.66 0 1.19 2.58 1.19 5.75z" />
                        </svg>
