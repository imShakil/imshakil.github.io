...
export default function Footer() {
  ...
  return (
    <footer className="bg-gray-50 dark:bg-slate-900/50 border-t border-gray-200 dark:border-slate-800">
      <div className="max-w-6xl mx-auto px-6 py-16 md:py-20">
        ...
        {/* Social Links */}
        <div className="flex justify-center gap-6 py-8 border-t border-gray-200 dark:border-slate-800">
        ...
        <div className="text-center pt-8 border-t border-gray-200 dark:border-slate-800">
          <p className="text-gray-600 dark:text-gray-400">
            © {currentYear} Mobarak Hosen · Built with Next.js & Tailwind CSS
          </p>
        </div>
      </div>
    </footer>
