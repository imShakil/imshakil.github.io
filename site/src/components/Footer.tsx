        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="flex flex-wrap gap-x-4 gap-y-2 sm:flex-col sm:space-y-2">
              ...
              <li>
                <a href="/resume/resume.pdf" target="_blank" className="text-gray-300 hover:text-blue-400 transition-all duration-200 flex items-center gap-2 hover:bg-slate-800/50 rounded px-2 py-1">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
